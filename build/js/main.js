...
/***/ function(module, exports) {
	...
	reviewFields.onchange = function() {
	  if ((reviewFieldsName.style.display = 'none') && (reviewFieldsText.style.display = 'none')) {
	...
	// if (!reviewFormField.required.valueMissing) {
	//     reviewFields.style.display = 'none';
	// } else {
	//     reviewFields.style.display = '';
	// }
